...
From the original plot, a transformation seems useful because the variation gets larger when the level is higher. This suggests the variance is not constant, so it makes sense to compare log and Box-Cox transformations and choose the one that stabilises the variation best.
...
# Log plot
print_retail_act %>% autoplot(log(y)) +
  labs(x = "Month",
       y = "log(Turnover)",
